    ...
    <div className="space-y-4">
      ...
      {products.length > 0 ? (
        ...
        <div className="rounded-lg p-8 text-center bg-white" style={{ border: `1px solid ${V2_CARD_BORDER}` }}>
          ...
          <p className="text-[14px] font-semibold mb-1" style={{ color: "var(--t-text)" }}>No products yet</p>
          <p className="text-[13px]" style={{ color: "var(--t-subtle)" }}>Add your first product to get started</p>
        </div>
      )}
