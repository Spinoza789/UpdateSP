      ...
      <div className="grid min-w-[680px] grid-cols-3">
        {STAGES.map((stage, index) => {
          ...
          return (
            ...
            >
              <span
                className="flex h-9 w-9 shrink-0 items-center justify-center border font-mono text-[11px] font-bold"
                style={{
              ...
              <span className="min-w-0 flex-1">
                <span className="flex items-center gap-2 text-[13px] font-extrabold uppercase tracking-[0.1em]">
                  {stage.label}
                  <Icon className="h-3.5 w-3.5 opacity-60" aria-hidden="true" />
                </span>
                <span className="mt-1 block text-[11px] font-medium opacity-65">{stage.verb}</span>
              </span>
