          ...
          {expandedSection === "shipping-options" && (
            <div className="p-4 space-y-3">
              <div className="p-3 rounded-lg" style={{ background: "#EFF6FF", border: "1px solid #DBEAFE" }}>
                ...
                <p className="text-[12px] leading-relaxed mt-2" style={{ color: "var(--t-muted)" }}>
                ...
                <div key={option.id} className="p-3 rounded-lg space-y-2" style={{ border: `1px solid ${V2_CARD_BORDER}`, background: "var(--t-surface2)" }}>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 h-9 px-3 rounded-lg text-[13px] font-semibold outline-none"
                    ...
                    <div className="flex items-center gap-1 px-2.5 h-9 rounded-lg" style={{ border: `1px solid ${V2_CARD_BORDER}`, background: "#fff" }}>
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        className="w-20 bg-transparent text-[13px] outline-none text-right"
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <label className="flex items-center gap-1.5 text-[11px] font-semibold cursor-pointer" style={{ color: "var(--t-subtle)" }}>
                      <input
                        type="checkbox"
              ...
              >
                ...
                <span className="text-[12px] font-semibold">Add Shipping Option</span>
              </button>
                  ...
                  <div className="space-y-3">
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        <div>
                          <p className="text-[12px] font-semibold" style={{ color: "var(--t-text)" }}>Equal portion</p>
                        ...
                        <div className="flex items-center gap-1.5">
                          <input
                            ...
                            className="w-16 text-center text-[13px] h-9 px-2 rounded-lg outline-none"
                            style={{ border: `1px solid ${V2_CARD_BORDER}`, color: "var(--t-text)", background: "#fff" }}
                          />
                          <span className="text-[12px]" style={{ color: "var(--t-subtle)" }}>%</span>
                        </div>
                      </div>
                      <input
                        type="range"
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        <div>
                          <p className="text-[12px] font-semibold" style={{ color: "var(--t-text)" }}>Quantity-weighted</p>
