...
export const SITE_CONFIG_REGISTRY: ConfigKeyDescriptor[] = [
  ...
  { key: "wholesale_usdc_erc20_wallet", type: "string", group: "Wholesale", label: "USDC ERC-20 wallet", description: "USDC ERC-20 wallet shown to wholesale customers.", defaultValue: null },
  { key: "wholesale_usdt_sol_wallet", type: "string", group: "Wholesale", label: "USDT Solana wallet", description: "USDT Solana wallet shown to wholesale customers.", defaultValue: null },
  { key: "wholesale_usdc_sol_wallet", type: "string", group: "Wholesale", label: "USDC Solana wallet", description: "USDC Solana wallet shown to wholesale customers.", defaultValue: null },
