/**
 * Shared country helpers. DB may store country as either a full name ("United Kingdom")
 * or an ISO-2 code ("GB"). All comparison logic normalises to ISO-2 before comparing.
 */
