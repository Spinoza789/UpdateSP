...
- endotoxin_eu_mg: Extract the endotoxin value as a number. If the report shows EU/mg, use that directly. If it shows EU/vial (e.g. "2.076 EU/Vial"), store the raw number as-is (2.076) — do not try to convert or skip it. We handle the unit context separately.
...
- compound_name: The compound or peptide name being tested. Extract the name exactly as it appears in the report — even if abbreviated (e.g. "tesa", "bpc", "tb", "gh", "reta"). Do NOT leave this null just because the name looks short or informal. For blends, use the blend name if visible (e.g. "KLOW") or a combined name like "BPC-157/TB-500 blend".
