...
import { FlaskConical, MapPin, ChevronRight, Info, Package, Calendar } from 'lucide-react';

const accent = "#5B8DEF";
const bg = "linear-gradient(135deg, #0D1B2A 0%, #162A44 100%)";
const blob = "rgba(91,141,239,0.18)";

export function CleanBlue() {
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#080D14" }}>
