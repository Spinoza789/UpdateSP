...
import { Dna, MapPin, ChevronRight, Info, Package } from 'lucide-react';

const accent = "#A78BFA";
const bg = "linear-gradient(135deg, #0F0A1E 0%, #1D1040 100%)";
const blob = "rgba(167,139,250,0.16)";

export function CleanPurple() {
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#080512" }}>
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 mb-2">
                <Dna className="w-3.5 h-3.5 shrink-0" style={{ color: accent }} />
