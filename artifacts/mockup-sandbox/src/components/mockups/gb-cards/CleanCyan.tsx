...
import { Activity, MapPin, ChevronRight, Info, Package } from 'lucide-react';

const accent = "#22D3EE";
const bg = "linear-gradient(135deg, #061819 0%, #0D2D2E 100%)";
const blob = "rgba(34,211,238,0.14)";

export function CleanCyan() {
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#030D0E" }}>
