    ...
    <main className="min-h-screen p-5 sm:p-8" style={{ background: "#f7f5f0" }}>
      ...
      >
        <header className="flex items-start justify-between p-6 pb-5 sm:p-7 sm:pb-6">
          <div>
            <p className="text-[11px] font-extrabold uppercase tracking-[0.18em]" style={{ color: "#71838a" }}>Order balance</p>
           ...
           <span className="rounded-full px-3 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.12em]" style={{ background: "#dff1ee", color: "#216b68" }}>
            Due now
          </span>
        </header>
        ...
        <div className="mx-6 rounded-2xl p-5 sm:mx-7 sm:p-6" style={{ background: "#283c52" }}>
          <div className="flex items-center justify-between">
            ...
            <WalletCards className="h-5 w-5" style={{ color: "#8bd0c2" }} />
          </div>
          ...
          <div className="mt-4 flex items-center gap-2 text-[11px]" style={{ color: "#c1d0dc" }}>
             <ShieldCheck className="h-3.5 w-3.5" style={{ color: "#8bd0c2" }} />
        ...
        <div className="p-6 pt-6 sm:p-7">
          ...
          <div className="space-y-2">
             {[
              ...
              <button
                ...
                style={{
                   background: selected ? "#edf8f6" : "#fffdfa",
                   border: `1px solid ${selected ? "#9acfc5" : "#e8e1d6"}`,
                   boxShadow: selected ? "0 5px 14px rgba(33,107,104,0.10)" : "none",
                }}
              >
                 <span className="flex h-9 w-9 items-center justify-center rounded-xl" style={{ background: selected ? "#3f9990" : "#f3eee7", color: selected ? "#f4fffd" : "#84786a" }}>
                ...
                <span className="min-w-0 flex-1">
                 ...
                 <span className="flex h-5 w-5 items-center justify-center rounded-full" style={{ background: selected ? "#3f9990" : "transparent", border: `1.5px solid ${selected ? "#3f9990" : "#d7cec2"}` }}>
          ...
          <button
            ...
            className="mt-5 flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl px-4 py-3 text-sm font-extrabold text-white transition-all hover:brightness-105"
             style={{ background: "#2f7f7a", boxShadow: "0 8px 18px rgba(33,107,104,0.20)" }}
          >
            Continue to payment
