...
import { Zap, MapPin, ChevronRight, Info, Package } from 'lucide-react';

const accent = "#F59E0B";
const bg = "linear-gradient(135deg, #1A1208 0%, #2C1F0A 100%)";
const blob = "rgba(245,158,11,0.16)";

export function CleanAmber() {
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#0E0900" }}>
